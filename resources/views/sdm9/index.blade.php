            ...
            <div class="box-body">  
              <table id="example2421" class="table table-bordered table-hover">
                <thead>
                  ...
                  Tuliskan data aktivitas mengajar dosen tidak tetap pada satu tahun terakhir di PS ini dengan mengikuti format tabel berikut:  
                </h4>
                <!-- Akhir Judul -->
                  

              <tbody id="sdm9-list" name="sdm9-list">
                ...
                <tr>
                   ...
                   <tfoot>
                    <tr>
                     ...
                     <td style="border: 1px solid #000; padding: 5px; text-align: center;"><?php echo $totalrencana2 ?></td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: center;"><?php echo $totallaksana2 ?></td>
                   @if(Auth::User()->id_departemen!=10)
                   @if(Auth::User()->role==7)
                  ...
                  <?php $no = 0;?>
                   ...
                   <tr>
                     ...
                     <td style="border: 1px solid #000; padding: 5px; text-align: left;">{{ $sdm9->nama_sdm9 }}</td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: left;">{{ $sdm9->keahlian_sdm9 }}</td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: left;">{{ $sdm9->kode_sdm9 }}</td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: left;">{{ $sdm9->nama_mk_sdm9 }}</td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: center;">{{ $sdm9->jlh_kelas }}</td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: center;">{{ $sdm9->jlh_rencana_sdm9 }}</td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: center;">{{ $sdm9->jlh_laksana_sdm9 }}</td>
                     <td style="border: 1px solid #000; padding: 5px; text-align: left;"> <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-default{{$sdm9->id_aktivitas_mengajar_dosen_tidak_tetap}}">
                    <span>Ubah</span> </button>
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modald{{$sdm9->id_aktivitas_mengajar_dosen_tidak_tetap}}">
                        <span>Hapus</span></button>
                  </td>
                   </tr>

<!-- Delete -->
    <div class="modal fade" id="modald{{$sdm9->id_aktivitas_mengajar_dosen_tidak_tetap}}" tabindex="1" aria-hidden="true">
                              ...
                              <div class="modal-body">
                                <div class="box box-info">
                                  <div class="box-body">
                                        ...
                                        <a>
                                          {!! Form::open(['method' => 'DELETE','route' => ['sdm9.destroy', $sdm9->id_aktivitas_mengajar_dosen_tidak_tetap],'style'=>'display:inline']) !!}
                                          {!! Form::submit('&nbsp;&nbsp;Ya&nbsp;&nbsp;', ['class' => 'btn btn-danger']) !!}
                                          {!! Form::close() !!}
                                        </a>
                                        <a href="/sdm9" class="btn btn-primary">
                                        <i class="#"> Tidak</i>
                                        </a>              
                  ...
                  <!-- Edit -->
               <div class="modal fade" id="modal-default{{$sdm9->id_aktivitas_mengajar_dosen_tidak_tetap}}">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="box box-info">
                        {!! Form::open(array('route' => ['sdm9.update', $sdm9->id_aktivitas_mengajar_dosen_tidak_tetap],'class'=>'form-horizontal','method'=>'PUT')) !!}
                        <div class="box-body">                                         
                           <div class="form-group">
                            <label class="col-xs-12 col-sm-6 col-md-8">Nama Dosen Tetap :</label>
                            <div class="col-sm-11">
                             {!! Form::text('nama_sdm9', $sdm9->nama_sdm9, array('placeholder' => 'Nama Dosen Tetap','class' => 'form-control')) !!}
                            </div>
                          </div>    
                           <div class="form-group">
                            <label class="col-xs-12 col-sm-6 col-md-8">Bidang Keahlian :</label>
                            <div class="col-sm-11">
                             {!! Form::text('keahlian_sdm9', $sdm9->keahlian_sdm9, array('placeholder' => 'Bidang Keahlian','class' => 'form-control')) !!}
                            </div>
                          </div> 
                          <div class="form-group">
                            <label class="col-xs-12 col-sm-6 col-md-8">Kode Mata Kuliah :</label>
                            <div class="col-sm-11">
                             {!! Form::text('kode_sdm9', $sdm9->kode_sdm9, array('placeholder' => 'Kode Mata Kuliah','class' => 'form-control')) !!}
                            </div>
                          </div> 
                          <div class="form-group">
                            <label class="col-xs-12 col-sm-6 col-md-8">Nama Mata Kuliah :</label>
                            <div class="col-sm-11">
                             {!! Form::text('nama_mk_sdm9', $sdm9->nama_mk_sdm9, array('placeholder' => 'Nama Mata Kuliah','class' => 'form-control')) !!}
                            </div>
                          </div>   
                        <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">Jumlah Kelas :</label>
                            ...
                            <select name="id_jlh_kelas" class="form-control">
                                <option value="1" {{$sdm9->id_jlh_kelas ? 'selected' : ''}}>1</option>
                                <option value="2" {{$sdm9->id_jlh_kelas ? 'selected' : ''}}>2</option>
                                <option value="3" {{$sdm9->id_jlh_kelas ? 'selected' : ''}}>3</option>
                                <option value="4" {{$sdm9->id_jlh_kelas ? 'selected' : ''}}>4</option>
                                <option value="5" {{$sdm9->id_jlh_kelas ? 'selected' : ''}}>5</option>
                              </select>
                            </div>
                        </div>         
                          <div class="form-group">
                            ...
                            <div class="col-sm-11">
                             {!! Form::number('jlh_rencana_sdm9', $sdm9->jlh_rencana_sdm9, array('placeholder' => 'Jumlah Pertemuan Yang Direncanakan','class' => 'form-control')) !!}
                            </div>
                          </div>  
                          <div class="form-group">
                            <label class="col-xs-12 col-sm-6 col-md-8">Jumlah Pertemuan Yang Dilaksanakan :</label>
                            <div class="col-sm-11">
                             {!! Form::number('jlh_laksana_sdm9', $sdm9->jlh_laksana_sdm9, array('placeholder' => 'Jumlah Pertemuan Yang Dilaksanakan','class' => 'form-control')) !!}
                            </div>
                          </div>                     
                          <div class="form-group">
                            <div class="modal-footer">
...
<!-- Tambah Data -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="box box-info">
            <!-- form start -->
            {!! Form::open(array('route' => 'sdm9.store','class'=>'form-horizontal','method'=>'POST')) !!}
              <div class="box-body">
              <div class="form-group">
                  <label class="col-xs-12 col-sm-6 col-md-8">Nama Dosen Tetap :</label>
                  <div class="col-sm-10">
                  {!! Form::text('nama_sdm9', null, array('placeholder' => 'Nama Dosen','class' => 'form-control')) !!}  
                </div>
              </div> 
              <div class="form-group">
                  <label class="col-xs-12 col-sm-6 col-md-8">Bidang Keahlian :</label>
                  <div class="col-sm-10">
                  {!! Form::text('keahlian_sdm9', null, array('placeholder' => 'Bidang Keahlian','class' => 'form-control')) !!}  
                </div>
              </div> 
                <div class="form-group">
                  <label class="col-xs-12 col-sm-6 col-md-8">Kode Mata Kuliah :</label>
                  <div class="col-sm-10">
                  {!! Form::text('kode_sdm9', null, array('placeholder' => 'Kode Mata Kuliah','class' => 'form-control')) !!}  
                </div>
              </div>    
              <div class="form-group">
                  <label class="col-xs-12 col-sm-6 col-md-8">Nama Mata Kuliah :</label>
                  <div class="col-sm-10">
                  {!! Form::text('nama_mk_sdm9', null, array('placeholder' => 'Nama Mata Kuliah','class' => 'form-control')) !!}  
                </div>
              </div> 
                ...
                <label class="col-xs-12 col-sm-6 col-md-8">Jumlah Kelas :</label>
                  ...
                  <div class="form-group">
                    <label class="col-xs-12 col-sm-6 col-md-8">Jumlah Pertemuan Yang Direncanakan :</label>
                      <div class="col-sm-10">
                     {!! Form::number('jlh_rencana_sdm9', null, array('placeholder' => 'Jumlah Pertemuan Yang Direncanakan','class' => 'form-control')) !!}
                    </div>
                   </div>   
                  <div class="form-group">
                    <label class="col-xs-12 col-sm-6 col-md-8">Jumlah Pertemuan Yang Dilaksanakan :</label>
                      <div class="col-sm-10">
                     {!! Form::number('jlh_laksana_sdm9', null, array('placeholder' => 'Jumlah Pertemuan Yang Dilaksanakan','class' => 'form-control')) !!}
                    </div>
                   </div>                              
              <div class="form-group">
                <div class="modal-footer">
  ...
  <div class="modal fade" id="modal-exim21" tabindex="1" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <form method="post" action=" {{ route('sdm9.import') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hiddem="true"> &times; </span>
    ...
    <div class="modal fade" id="modal21" tabindex="1" aria-hidden="true">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <form method="post" action=" {{ route('sdm9.download') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                    {{ csrf_field() }}
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hiddem="true"> &times; </span>
            ...
            <div class="modal-body">
              <div class="box box-info">
                <div class="box-body">
                  <div class="form-group">              
                    <div class="col-sm-10">
                      <a href="{{ route('sdm9.export') }}" class="btn btn-primary btn-md">
                        <i class="fa fa-download"> Unduh Excel</i>
                      </a>
                      <a href="downloadsdm9" class="btn btn-primary btn-md">
