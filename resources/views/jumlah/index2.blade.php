 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1 style="text-transform: uppercase;">
        KEMAHASISWAAN @if(Auth::User()->id_departemen==10) FMIPA IPB @elseif(Auth::User()->id_departemen!=10) program studi {{$dept[0]->nama_departemen}} @endif
      </h1>    
    </section>
      ...
      <div class="row">
       ...
       <!-- cari -->
         ...
         <form id="id_jumlah" class="form-horizontal" role="form" method="POST" action="{{ 'cariTahun' }}">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="form-group">
                <label class="col-md-3 control-label" style="margin-left: 90px"></label>
                  <div class="col-md-2 ">
          ...
          <!-- tutup -->
            ...
            <div class="panel-body"  style="margin-bottom: 400px"> 
              <table id="example2" class="table table-bordered table-hover dataTable">
                <thead>
                  <tr>
                  <h4 style="text-align: left"> Tabel 3.1 Data Kemahasiswaan @if(Auth::User()->id_departemen==10) FMIPA IPB menurut Tipe Program dan Jenis Mahasiswa per Program Studi @elseif(Auth::User()->id_departemen!=10) Program Studi {{$dept[0]->nama_departemen}} FMIPA IPB @endif</h4>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Data Mahasiswa {{$dept[0]->nama_departemen}}</h4>
              </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
              <h3 class="modal-title">Tambah Mahasiswa {{$dept[0]->nama_departemen}}</h3>
            </div>
            <div class="modal-body">
              <div class="box box-info">
              ...
              <div class="modal-header">
                <div class="form-group">
                  <label class="col-sm-5 control-label">Tahun</label>
                    <div class="col-sm-6">
                    {!! Form::selectRange('tahun','2014', '2060', array('placeholder' => 'Tahun','class' => 'form-control', 'min'=>2016)) !!}
                    </div>
                </div>
              <div class="form-group">
              <label class="col-sm-5 control-label">Daya Tampung</label>
          ...
          <div class="modal-content">
            ...
            {{ csrf_field() }}
              <div class="modal-header">
                ...
                <h3 class="modal-title">Upload Data Jumlah Mahasiswa {{$dept[0]->nama_departemen}}</h3>
              </div>   
              <div class="modal-body">
                <div class="box box-info">
                  <div class="box-body">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title">Download Laporan Jumlah Mahasiswa {{$dept[0]->nama_departemen}}</h3>
        </div>   
        <div class="modal-body">
          <div class="box box-info">
            <div class="box-body">
