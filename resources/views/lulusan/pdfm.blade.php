...
<table cellspacing="0">
           <tr>
            <th colspan="1" align=left valign=top><font face="Times New Rowman" >Tabel 3.2</font></th>
             <td colspan="4" style="text-align: left"><font face="Times New Rowman" >Rata-rata Masa Studi dan IPK lulusan menurut Program Studi periode TA <?php echo Carbon::now()->startOfYear()->subYear(3)->format('Y') ?>/<?php echo Carbon::now()->startOfYear()->subYear(2)->format('Y') ?>, <?php echo Carbon::now()->startOfYear()->subYear(2)->format('Y') ?>/<?php echo Carbon::now()->startOfYear()->subYear(1)->format('Y') ?>, dan <?php echo Carbon::now()->startOfYear()->subYear(1)->format('Y') ?>/<?php echo Carbon::now()->startOfYear()->format('Y') ?></font></td>
           </tr>
            <tr>
            <th></th>
            <th rowspan="2" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;" style="text-align: center;"><font face="Times New Rowman" >Program Studi</font></th>
            <th colspan="2" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;"><font face="Times New Rowman" >MASA STUDI</font></th>
            <th rowspan="1" style="border:1px solid #000; border-bottom:0px; border-bottom:0px; border-width: thin; background-color:#daeef3;text-align: center"><font face="Times New Rowman" >Rata-rata</font></th>
            </tr>
            <tr>
            <th></th>
            <th colspan="1" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;"><font face="Times New Rowman" >(Bulan)</font></th>
            <th colspan="1" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;"><font face="Times New Rowman" >(Tahun)</font></th>
            <th rowspan="1" style="border:1px solid #000; border-top:0px; border-bottom:0px; border-width: thin; background-color:#daeef3;text-align: center"><font face="Times New Rowman" > IPK Lulusan</font></th>
            <!-- <th></th> -->
            </tr>
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G1 PS1-STATISTIKA</font></p></td>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;" align=center><p style="font-size:14px"><font face="Times New Rowman"><?php echo number_format(DB::table('lulusans')->whereBetween('tahun_lulus', [Carbon::now()->startOfYear()->subYear(2)->subMonth(4),Carbon::now()->startOfYear()->addYear(1)->subMonth(4)])->join('departemen', 'id_dept', '=', 'id_departemen')->where('id_departemen', $id_departemen=1)->avg('total_bulan'),2) ?></font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G2 PS2-METEOROLOGI TERAPAN</font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G3 PS3-BIOLOGI</font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G4 PS4-KIMIA</font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G5 PS5-MATEMATIKA</font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G6 PS6-ILMU KOMPUTER</font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G7 PS7-FISIKA</font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G8 PS8-BIOKIMIA</font></p></td>
            ...
            <tr>
            <th></th>
            <td colspan="1" style="border:1px solid #000; border-width: thin; background-color:#255255255;"><p style="font-size:14px"><font face="Times New Rowman">G9 PS9-AKTUARIA</font></p></td>
            ...
            <tr>
            <th></th>
            <th colspan="1" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;" align=right><font face="Times New Rowman" >RATA-RATA FMIPA</font></th>
            <th colspan="1" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;" align=right><font face="Times New Rowman" ><?php echo number_format($rata_bln,2) ?></font></th>
            <th colspan="1" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;" align=right><font face="Times New Rowman" ><?php echo number_format($rata_thn,2) ?></font></th>
            <th colspan="1" align="center" style="border:1px solid #000; border-width: thin; background-color:#daeef3;" align=right;><font face="Times New Rowman" ><?php echo number_format($rata_ipk,2) ?></font></th>
            </tr>
            <tr>
            <th></th>
            <th></th>
            ...
            <tr>
            <td></td>
            <td colspan="2"><p style="font-size:14px"><font face="Times New Rowman"><u>Catatan:</u> * Belum ada lulusan</font></p></td>
            </tr>;
