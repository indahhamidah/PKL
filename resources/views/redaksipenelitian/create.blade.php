 ...
 <!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
          <form method="post" action=" {{ route('simpan.redaksi') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }}
            <div class="box-header">
            <!-- /.box-header -->
                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="redaksipenelitian" rows="40" cols="5" oneKeyPress class="form-control my-editor" name="redaksi_penelitian" value="{{ old('redaksi_penelitian') }}"></textarea>
          </div>
