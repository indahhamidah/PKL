...
<p style="font-size: 12;font-family: arial, helvetica, sans-serif;"><b>STANDAR 2 TATA PAMONG DAN KERJASAMA</b></p>
        ...
        <p style="font-size: 11;font-family: arial, helvetica, sans-serif;"><strong>Tabel 2.</strong> Kerjasama dengan Instansi Luar Negeri Program Studi {{$kerlu[0]->nama_departemen}}</p>
    <table cellspacing="0" >
    	<tr>
            <th></th>
