     ...
     <?php $no++ ;?>
                  <tr>
                    <th></th>
                     ...
                     <td style="border:1px solid #000;"><p style="font-size:16px"><font face="Times New Rowman" > {{$kegiatan->isi_kurikulumf}}</font></p></td>
                     <td style="border:1px solid #000;"><p style="font-size:16px"><font face="Times New Rowman" > {{$kegiatan->penyelenggara}}</font></p></td>
                     <td style="border:1px solid #000;text-align: center;"><p style="font-size:16px"><font face="Times New Rowman" > {{$kegiatan->tahun_kurikulumf}}</font></p></td>
