          ...
          {{ csrf_field() }}
            ...
            <!-- /.box-header -->
                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="kompetensi_lainnya" rows="4" cols="50" oneKeyPress class="form-control my-editor" name="keterangan_kompetensi_lainnya" value="{{ old('kompetensi_lainnya') }}"></textarea>
          </div>
