        ...
        <div class="box-body">
          <table class="table table-bordered">
            <div class="panel panel-default">
                ...
                <h4>
                <strong>4.1.3 Pandangan FMIPA IPB tentang data pada butir 4.1.1 dan 4.1.2, yang mencakup aspek: kecukupan, kualifikasi, dan pengembangan karir, serta kendala yang ada dalam pengembangan tenaga dosen tetap.</strong>
                </h4>
                </div>
          ...
          <table>
             <strong>&nbsp;&nbsp;&nbsp;Tabel 4.1.3 Perencanaan dosen FMIPA menurut Departemen hingga tahun 2030</strong>
             <tr>
                     <th rowspan="2" style="border: 1px solid #000; padding: 5px; text-align: center">Departemen*</th>
                     <th colspan="19" style="border: 1px solid #000; padding: 5px; text-align: center">Tahun Perekrutan Dosen 20..</th>
                     <th rowspan="2" style="border: 1px solid #000; padding: 5px; text-align: center" >Jumlah Dosen Baru</th>
                     <th rowspan="2" style="border: 1px solid #000; padding: 5px; text-align: center" >Jumlah Dosen 2030</th>
                     <tr>
                   ...
                   <tr>
                       ...
                       <td style="border: 1px solid #000; padding: 5px; text-align: center">1</td>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">22</th>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">33</th>
                   </tr>
                   <tr>
                   ...
                   <tr>
                       ...
                       <td style="border: 1px solid #000; padding: 5px; text-align: center">3</td>
                       <td style="border: 1px solid #000; padding: 5px; text-align: center">2</td>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">48</th>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">62</th>
                   </tr>
                   <tr>
                       ...
                       <td style="border: 1px solid #000; padding: 5px; text-align: center">1</td>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">25</th>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">38</th>
                   </tr>
                   <tr>
                       ...
                       <td style="border: 1px solid #000; padding: 5px; text-align: center">2</td>
                       <td style="border: 1px solid #000; padding: 5px; text-align: center">2</td>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">31</th>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">36</th>
                   </tr>
                   <tr>
                       ...
                       <td style="border: 1px solid #000; padding: 5px; text-align: center">1</td>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">21</th>
                       <th style="border: 1px solid #000; padding: 5px; text-align: center">41</th>
                   </tr>
                   <tr>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">4.1.3 Pandangan FMIPA IPB tentang data pada butir 4.1.1 dan 4.1.2, yang mencakup aspek: kecukupan, kualifikasi, dan pengembangan karir, serta kendala yang ada dalam pengembangan tenaga dosen tetap.</h4>
      </div>
      <div class="modal-body">
        <div class="box box-info">
          {!! Form::open(array('route'=>'Sdm_Fmipa_1', 'class'=>'form-horizontal', 'method'=>'PUT')) !!}
          <div class="box-body">
          @foreach($peran as $penjelasan)
