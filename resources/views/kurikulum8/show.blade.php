          ...
          {{ csrf_field() }}
            ...
            <!-- /.box-header -->
                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="mekanisme_peninjauan_kurikulum" rows="4" cols="50" oneKeyPress class="form-control my-editor" name="keterangan_mekanisme_peninjauan_kurikulum" value="{{ old('mekanisme_peninjauan_kurikulum') }}"></textarea>
          </div>
           <div class="form-group" >
                            <div class="col-md-12 col-md-offset-6 text-right" style="margin-top:100px">
                                ...
                                <button type="button" class="col-md-2 btn btn-danger" style="margin-left:10px" onclick="window.location='{{ url('/standar6kurikulum08') }}'" >Cancel</button>
