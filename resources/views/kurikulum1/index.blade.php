        ...
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
              @if(Auth::User()->id_departemen!=10)
                @if(Auth::User()->role==10)
                  ...
                  <a class="btn btn-primary" href="{{ route('standar6kurikulum01.edit',$visi->id_kompetensi_utama_lulusan) }}">
                  <i class="fa fa-edit"></i>Ubah</a>
                  @endforeach
                  <a href="{{ route('kurikulum1.download') }}" class="btn btn-primary btn-md">
                  ...
                  <a href="{{ route('create.kurikulum01') }}" class="btn btn-primary btn-md">
          ...
          <!-- tutup -->
            <div class="panel panel-default">
                ...
                <strong>Uraikan secara ringkas kompetensi utama lulusan.</strong>
                </h4>
                </div>
                    <div class="panel-body">
                      @foreach ($kompetensi_utama_lulusan as $visi)
                      {!! $visi->keterangan_kompetensi_utama_lulusan !!}
