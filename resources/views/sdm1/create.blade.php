 ...
 <!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
          <form method="post" action=" {{ route('simpan.sdm01') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }}
            <div class="box-header">
            <!-- /.box-header -->
                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="sistem_seleksi_dan_pengembangan" rows="40" cols="5" oneKeyPress class="form-control my-editor" name="keterangan_seleksi_dan_pengembangan" value="{{ old('sistem_seleksi_dan_pengembangan') }}"></textarea>
          </div>
