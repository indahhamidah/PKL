...
<!-- Main content -->
    <section class="content">
      ...
      <!--     <form method="post" action=" {{ route('ubah.visimisi') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }} -->
              {!! Form::open(array('route' => ['redaksipengabdian.update', $redaksipengabdian->id_redaksiPeng],'class'=>'form-horizontal','method'=>'PUT')) !!}
                   
            <div class="box-header">
            <!-- /.box-header -->

                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="redaksipengabdian" rows="50" cols="5" oneKeyPress class="form-control my-editor" name="redaksi_pengabdian"></textarea>
                      <div class="form-group" >
                            <div class="col-md-12 col-md-offset-6 text-right" style="margin-top:100px">
                                ...
                                <button type="button" class="col-md-2 btn btn-danger" style="margin-left:10px" onclick="window.location='{{ url('/redaksipengabdian') }}'" >Kembali</button>
  ...
  <!--Text Editor-->
    ...
    <script>
      ...
      var contentEditor = {!! $redaksipengabdian !!}.redaksi_pengabdian;  // the way you pars the variabel from controller
      document.getElementById('redaksipengabdian').innerHTML = contentEditor; 
    </script>
