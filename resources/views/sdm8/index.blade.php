...
@section('content')
 ...
 <!-- Content Header (Page header) -->
        ...
        <div class="col-xs-12">
          ...
          <div class="panel-body"  style="margin-bottom: 400px"> 
              <table id="example2" class="table table-bordered table-hover dataTable">
                <thead>
                  <h4 style="text-align: center;"> Tuliskan data dosen tidak tetap pada PS dengan mengikuti format tabel berikut:</h4>
                  <tr>
                  <th style="text-align: center;background-color:#daeef3;border: 1px solid #000">No</th>
                  <th rowspan="2" style="text-align: center;background-color:#daeef3;border: 1px solid #000">Nama Dosen Tidak Tetap</th>
                  ...
                  <tbody id="sdm8s" name="sdm8">
                  <?php $nomor = 0;?>
                  @foreach ($sdm8s as $sdm8)
                  <?php $nomor++ ;?>
                   <tr>
                  <td style="text-align: center;border: 1px solid #000">{{ $nomor }}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm8->nama_dosen_sdm8}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm8->nidn_sdm8}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm8->tanggal_lahir}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm8->jabatan}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm8->gelar_sdm8}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm8->pendidikan_sdm8}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm8->bidang_keahlian}}</td>
                   @if(Auth::User()->id_departemen!=10)
                   @if(Auth::User()->role==7)
                  <td style="text-align: center;border: 1px solid #000">
                    <button type="button" class=" btn-sm" data-toggle="modal" data-target="#modal-default2{{$sdm8->id_data_dosen_tidak_tetap}}">
                    ...
                    <td style="text-align: center;border: 1px solid #000">
                    @foreach ($lampiran_sdm8 as $lampiransdm8P)
                      @if($lampiransdm8P->id_lampiran_sdm8==$sdm8->id_lampiran_sdm8)
                      <a href="{{ route('downloadlampiransdm8', $lampiransdm8P->id_lampiran_sdm8) }}" >
                    ...
                    @endforeach
                      ...
                      <td style="text-align: center;border: 1px solid #000">
                        @if(isset($sdm8->id_lampiran_sdm8))
                  ...
                  @if(Auth::user()->id_departemen!=10)
                    ...
                    @if(Auth::user()->role!=8)
                    <td style="text-align: center;border: 1px solid #000"> 
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-default{{$sdm8->id_data_dosen_tidak_tetap}}">
                        <span>&nbsp;Ubah&nbsp;</span></button>
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modald{{$sdm8->id_data_dosen_tidak_tetap}}">
                  ...
                  @elseif(Auth::User()->id_departemen==10)
                    @if(Auth::User()->role!=1)
                     <td> 
                        ...
                        {!! Form::open(['method' => 'DELETE','route' => ['Sdm_Departemen_8.destroy', $sdm8->id_data_dosen_tidak_tetap],'style'=>'display:inline']) !!}
    ...
    <!-- Upload Bukti -->
       <div class="modal fade" id="modal-default2{{$sdm8->id_data_dosen_tidak_tetap}}">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <form method="post" action=" {{ route('lampiransdm8.upload') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <h3 class="modal-title">Unggah Lampiran</h3>
                ...
                <div class="modal-body">
                  ...
                  {!! Form::open(array('route' => 'lampiransdm8.upload','class'=>'form-horizontal','method'=>'POST')) !!}
                      <div class="box-body">
                     {!! Form::hidden('id_data_dosen_tidak_tetap', $sdm8->id_data_dosen_tidak_tetap, array('placeholder' => 'id Sdm8','class' => 'form-control')) !!}
                     @if(Auth::user()->id_departemen==10)
                        {!! Form::hidden('id_departemen', $sdm8->id_departemen, array('placeholder' => 'id departemen','class' => 'form-control')) !!}
                     @endif
                        <label for="file" class="col-sm-5 control-label">Unggah</label>
                          <div class="col-sm-6">
                          <input type="file" id="file" name="lampiransdm8" class="form-control" autofocus required>
...
<!-- Delete -->
    <div class="modal fade" id="modald{{$sdm8->id_data_dosen_tidak_tetap}}" tabindex="1" aria-hidden="true">
                        <div class="modal-dialog modal-md">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="box box-info">
                                  <div class="box-body">
                                        ...
                                        <a href="/Sdm_Departemen_8" class="btn btn-primary">
                                        <i class="#"> Tidak</i>
                                        </a>              
                                        <span class="help-block with-errors"></span>
                                  </div>
          ...
          <!-- Edit -->
          <div class="modal fade" id="modal-default{{$sdm8->id_data_dosen_tidak_tetap}}">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="box box-info">
                    {!! Form::open(array('route' => ['Sdm_Departemen_8.update', $sdm8->id_data_dosen_tidak_tetap],'class'=>'form-horizontal','method'=>'PUT')) !!}
                    <div class="box-body">
                        <div class="form-group">
                         <label class="col-xs-12 col-sm-4 col_md-8">Nama Dosen Tetap :</label>
                            <div class="col-sm-6">
                            {!! Form::text('nama_dosen_sdm8', $sdm8->nama_dosen_sdm8, array('placeholder' => 'Nama Dosen Tetap','class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">NIDN :</label>
                            <div class="col-sm-6">
                            {!! Form::number('nidn_sdm8', $sdm8->nidn_sdm8, array('placeholder' => 'NIDN','class' => 'form-control', 'min'=>0)) !!}
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            {!! Form::date('tanggal_lahir', $sdm8->tanggal_lahir, array('placeholder' => 'Tanggal Lahir','class' => 'form-control')) !!}
                          </div>
                     ...
                     <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">Jabatan Akademik :</label>
                            ...
                            <select name="id_jabatan" class="form-control">
                                <option value="1" {{$sdm8->id_jabatan==1 ? 'selected' : ''}}>DOSEN PNS/CPNS***</option>
                                <option value="2" {{$sdm8->id_jabatan==2 ? 'selected' : ''}}>ASISTEN AHLI***</option>
                                <option value="3" {{$sdm8->id_jabatan==3 ? 'selected' : ''}}>LEKTOR***</option>
                                <option value="4" {{$sdm8->id_jabatan==4 ? 'selected' : ''}}>LEKTOR KEPALA***</option>
                                <option value="5" {{$sdm8->id_jabatan==5 ? 'selected' : ''}}>GURU BESAR/PROFESOR***</option>
                                <option value="6" {{$sdm8->id_jabatan==6 ? 'selected' : ''}}>DOSEN PNS/CPNS</option>
                                <option value="7" {{$sdm8->id_jabatan==7 ? 'selected' : ''}}>ASISTEN AHLI</option>
                                <option value="8" {{$sdm8->id_jabatan==8 ? 'selected' : ''}}>LEKTOR</option>
                                <option value="9" {{$sdm8->id_jabatan==9 ? 'selected' : ''}}>LEKTOR KEPALA</option>
                                <option value="10" {{$sdm8->id_jabatan==10 ? 'selected' : ''}}>GURU BESAR/PROFESOR</option>
                              </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                          {!! Form::text('gelar_sdm8', $sdm8->gelar_sdm8, array('placeholder' => 'Gelar Akademik','class' => 'form-control')) !!}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">Pendidikan dan Asal PT :</label>
                            <div class="col-sm-6">
                            {!! Form::text('pendidikan_sdm8', $sdm8->pendidikan_sdm8, array('placeholder' => 'Pendidikan dan Asal PT','class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">Bidang Keahlian :</label>
                            <div class="col-sm-6">
                            {!! Form::text('bidang_keahlian', $sdm8->bidang_keahlian, array('placeholder' => 'Bidang Keahlian','class' => 'form-control')) !!}
                            </div>
                        </div>
     ...
     <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="box box-info">
             {!! Form::open(array('route' => 'Sdm_Departemen_8.store','class'=>'form-horizontal','method'=>'POST')) !!}
              <div class="box-body">
              <div class="modal-header">
              <div class="form-group">
                <label class="col-sm-5 control-label">Nama Dosen Tetap :</label>
                  <div class="col-sm-6">
                  {!! Form::text('nama_dosen_sdm8', null, array('placeholder' => 'Nama Dosen Tetap','class' => 'form-control')) !!}
                  </div>
              </div>
              <div class="form-group">
                <label class="col-sm-5 control-label">NIDN :</label>
                  <div class="col-sm-6">
                  {!! Form::number('nidn_sdm8', null, array('placeholder' => 'NIDN','class' => 'form-control', 'min'=>0)) !!}
                  </div>
              </div> 
                <div class="form-group">
              ...
              <label class="col-sm-5 control-label">Gelar Akademik :</label>
                <div class="col-sm-6">
                {!! Form::text('gelar_sdm8', null, array('placeholder' => 'Gelar Akademik','class' => 'form-control')) !!}
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-5 control-label">Pendidikan dan Asal PT :</label>
                  <div class="col-sm-6">
                  {!! Form::text('pendidikan_sdm8', null, array('placeholder' => 'Pendidikan dan Asal PT','class' => 'form-control')) !!}
                  </div>
              </div>
              <div class="form-group">
  ...
  <div class="modal fade" id="modal-exim" tabindex="1" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <form method="post" action=" {{ route('sdm8.import') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hiddem="true"> &times; </span>
...
<!-- report -->
    <div class="modal fade" id="modal1" tabindex="1" aria-hidden="true">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <form method="post" action=" {{ route('sdm8.download') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                    {{ csrf_field() }}
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hiddem="true"> &times; </span>
            ...
            <div class="modal-body">
              <div class="box box-info">
                <div class="box-body">
                      ...
                      <a href="{{ route('sdm8.sdm8excel') }}" class="btn btn-primary" role="button">
                       <i class="fa fa-download"> Unduh Excel</i>
                      </a>
                      <a href="{{ route('sdm8.download')}}" class="btn btn-primary">
