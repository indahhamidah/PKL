          ...
          {{ csrf_field() }}
            ...
            <!-- /.box-header -->
                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="pandangan_fmipa_tentang_tendik" rows="4" cols="50" oneKeyPress class="form-control my-editor" name="keterangan_pandangan_fmipa_tentang_tendik" value="{{ old('pandangan_fmipa_tentang_tendik') }}"></textarea>
          </div>
           <div class="form-group" >
                            <div class="col-md-12 col-md-offset-6 text-right" style="margin-top:100px">
                                ...
                                <button type="button" class="col-md-2 btn btn-danger" style="margin-left:10px" onclick="window.location='{{ url('/standar4sdmfmipa02') }}'" >Cancel</button>
