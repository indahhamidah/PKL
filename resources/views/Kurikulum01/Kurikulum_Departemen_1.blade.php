        ...
        <div class="box-body">
          <table class="table table-bordered">
             <div class="panel panel-default">
                ...
                <h4>
                <strong>6.1.1 Uraikan secara ringkas kompetensi utama lulusan</strong>
                </h4>
                </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">6.1.1 Uraikan secara ringkas kompetensi utama lulusan</h4>
      </div>
      <div class="modal-body">
        <div class="box box-info">
          {!! Form::open(array('route'=>'Kurikulum_Departemen_1', 'class'=>'form-horizontal', 'method'=>'PUT')) !!}
          <div class="box-body">
          @foreach($peran as $penjelasan)
