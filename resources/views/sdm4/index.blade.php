...
@section('content')
 ...
 <!-- Content Header (Page header) -->
        ...
        <div class="col-xs-12">
          ...
          <div class="panel-body"  style="margin-bottom: 400px"> 
              <table id="example2" class="table table-bordered table-hover dataTable">
                <thead>
                  <h4 style="text-align: center;"> Data dosen tetap yang bidang keahliannya di luar bidang PS:</h4>
                  <tr>
                  ...
                  <tbody id="sdm4s" name="sdm4">
                  <?php $nomor = 0;?> 
                  @foreach ($sdm4s as $sdm4)
                  <?php $nomor++ ;?>
                   <tr>
                  <td style="text-align: center;border: 1px solid #000">{{ $nomor }}</td>
                  <td style="text-align: left;border: 1px solid #000">{{$sdm4->nama_dosen_sdm4}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm4->nidn_sdm4}}</td>
                  <td style="text-align: center;border: 1px solid #000">{{$sdm4->tanggal_lahir}}</td>
                  <td style="text-align: left;border: 1px solid #000">{{$sdm4->jabatan}}</td>
                  <td style="text-align: left;border: 1px solid #000">{{$sdm4->gelar_sdm4}}</td>
                  <td style="text-align: left;border: 1px solid #000">{{$sdm4->pendidikan_sdm4}}</td>
                  <td style="text-align: left;border: 1px solid #000">{{$sdm4->bidang_keahlian}}</td>
                   @if(Auth::User()->id_departemen!=10)
                   @if(Auth::User()->role==7)
                  <td style="text-align: center;border: 1px solid #000">
                    <button type="button" class=" btn-sm" data-toggle="modal" data-target="#modal-default2{{$sdm4->id_data_dosen_yang_bidangnya_diluar_ps}}">
                    ...
                    <td style="text-align: center;border: 1px solid #000">
                    @foreach ($lampiran_sdm4 as $lampiransdm4P)
                      @if($lampiransdm4P->id_lampiran_sdm4==$sdm4->id_lampiran_sdm4)
                      <a href="{{ route('downloadlampiransdm4', $lampiransdm4P->id_lampiran_sdm4) }}" >
                    ...
                    @endforeach
                      ...
                      <td style="text-align: center;border: 1px solid #000">
                        @if(isset($sdm4->id_lampiran_sdm4))
                  ...
                  @if(Auth::user()->id_departemen!=10)
                    ...
                    @if(Auth::user()->role!=8)
                    <td style="text-align: center;border: 1px solid #000"> 
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-default{{$sdm4->id_data_dosen_yang_bidangnya_diluar_ps}}">
                        <span>&nbsp;Ubah&nbsp;</span></button>
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modald{{$sdm4->id_data_dosen_yang_bidangnya_diluar_ps}}">
                  ...
                  @elseif(Auth::User()->id_departemen==10)
                    @if(Auth::User()->role!=1)
                     <td> 
                        ...
                        {!! Form::open(['method' => 'DELETE','route' => ['Sdm_Departemen_4.destroy', $sdm4->id_data_dosen_yang_bidangnya_diluar_ps],'style'=>'display:inline']) !!}
    ...
    <!-- Upload Bukti -->
       <div class="modal fade" id="modal-default2{{$sdm4->id_data_dosen_yang_bidangnya_diluar_ps}}">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <form method="post" action=" {{ route('lampiransdm4.upload') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <h3 class="modal-title">Unggah Lampiran</h3>
                ...
                <div class="modal-body">
                  ...
                  {!! Form::open(array('route' => 'lampiransdm4.upload','class'=>'form-horizontal','method'=>'POST')) !!}
                      <div class="box-body">
                     {!! Form::hidden('id_data_dosen_yang_bidangnya_diluar_ps', $sdm4->id_data_dosen_yang_bidangnya_diluar_ps, array('placeholder' => 'id Sdm4','class' => 'form-control')) !!}
                     @if(Auth::user()->id_departemen==10)
                        {!! Form::hidden('id_departemen', $sdm4->id_departemen, array('placeholder' => 'id departemen','class' => 'form-control')) !!}
                     @endif
                        <label for="file" class="col-sm-5 control-label">Unggah</label>
                          <div class="col-sm-6">
                          <input type="file" id="file" name="lampiransdm4" class="form-control" autofocus required>
...
<!-- Delete -->
    <div class="modal fade" id="modald{{$sdm4->id_data_dosen_yang_bidangnya_diluar_ps}}" tabindex="1" aria-hidden="true">
                        <div class="modal-dialog modal-md">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="box box-info">
                                  <div class="box-body">
                                        ...
                                        <a href="/Sdm_Departemen_4" class="btn btn-primary">
                                        <i class="#"> Tidak</i>
                                        </a>              
                                        <span class="help-block with-errors"></span>
                                  </div>
          ...
          <!-- Edit -->
          <div class="modal fade" id="modal-default{{$sdm4->id_data_dosen_yang_bidangnya_diluar_ps}}">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="box box-info">
                    {!! Form::open(array('route' => ['Sdm_Departemen_4.update', $sdm4->id_data_dosen_yang_bidangnya_diluar_ps],'class'=>'form-horizontal','method'=>'PUT')) !!}
                    <div class="box-body">
                        <div class="form-group">
                         <label class="col-xs-12 col-sm-4 col_md-8">Nama Dosen Tetap :</label>
                            <div class="col-sm-6">
                            {!! Form::text('nama_dosen_sdm4', $sdm4->nama_dosen_sdm4, array('placeholder' => 'Nama Dosen Tetap','class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">NIDN :</label>
                            <div class="col-sm-6">
                            {!! Form::number('nidn_sdm4', $sdm4->nidn_sdm4, array('placeholder' => 'NIDN','class' => 'form-control', 'min'=>0)) !!}
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            {!! Form::date('tanggal_lahir', $sdm4->tanggal_lahir, array('placeholder' => 'Tanggal Lahir','class' => 'form-control')) !!}
                          </div>
                      ...
                      <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">Jabatan Akademik :</label>
                            ...
                            <select name="id_jabatan" class="form-control">
                                <option value="1" {{$sdm4->id_jabatan==1 ? 'selected' : ''}}>DOSEN PNS/CPNS***</option>
                                <option value="2" {{$sdm4->id_jabatan==2 ? 'selected' : ''}}>ASISTEN AHLI***</option>
                                <option value="3" {{$sdm4->id_jabatan==3 ? 'selected' : ''}}>LEKTOR***</option>
                                <option value="4" {{$sdm4->id_jabatan==4 ? 'selected' : ''}}>LEKTOR KEPALA***</option>
                                <option value="5" {{$sdm4->id_jabatan==5 ? 'selected' : ''}}>GURU BESAR/PROFESOR***</option>
                                <option value="6" {{$sdm4->id_jabatan==6 ? 'selected' : ''}}>DOSEN PNS/CPNS</option>
                                <option value="7" {{$sdm4->id_jabatan==7 ? 'selected' : ''}}>ASISTEN AHLI</option>
                                <option value="8" {{$sdm4->id_jabatan==8 ? 'selected' : ''}}>LEKTOR</option>
                                <option value="9" {{$sdm4->id_jabatan==9 ? 'selected' : ''}}>LEKTOR KEPALA</option>
                                <option value="10" {{$sdm4->id_jabatan==10 ? 'selected' : ''}}>GURU BESAR/PROFESOR</option>
                              </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                          {!! Form::text('gelar_sdm4', $sdm4->gelar_sdm4, array('placeholder' => 'Gelar Akademik','class' => 'form-control')) !!}
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">Pendidikan dan Asal PT :</label>
                            <div class="col-sm-6">
                            {!! Form::text('pendidikan_sdm4', $sdm4->pendidikan_sdm4, array('placeholder' => 'Pendidikan dan Asal PT','class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-xs-12 col-sm-4 col_md-8">Bidang Keahlian :</label>
                            <div class="col-sm-6">
                            {!! Form::text('bidang_keahlian', $sdm4->bidang_keahlian, array('placeholder' => 'Bidang Keahlian','class' => 'form-control')) !!}
                            </div>
                        </div>
     ...
     <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="box box-info">
             {!! Form::open(array('route' => 'Sdm_Departemen_4.store','class'=>'form-horizontal','method'=>'POST')) !!}
              <div class="box-body">
              <div class="modal-header">
              <div class="form-group">
                <label class="col-sm-5 control-label">Nama Dosen Tetap :</label>
                  <div class="col-sm-6">
                  {!! Form::text('nama_dosen_sdm4', null, array('placeholder' => 'Nama Dosen Tetap','class' => 'form-control')) !!}
                  </div>
              </div>
              <div class="form-group">
                <label class="col-sm-5 control-label">NIDN :</label>
                  <div class="col-sm-6">
                  {!! Form::number('nidn_sdm4', null, array('placeholder' => 'NIDN','class' => 'form-control', 'min'=>0)) !!}
                  </div>
              </div> 
                <div class="form-group">
              ...
              <label class="col-sm-5 control-label">Gelar Akademik :</label>
                <div class="col-sm-6">
                {!! Form::text('gelar_sdm4', null, array('placeholder' => 'Gelar Akademik','class' => 'form-control')) !!}
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-5 control-label">Pendidikan dan Asal PT :</label>
                  <div class="col-sm-6">
                  {!! Form::text('pendidikan_sdm4', null, array('placeholder' => 'Pendidikan dan Asal PT','class' => 'form-control')) !!}
                  </div>
              </div>
              <div class="form-group">
  ...
  <div class="modal fade" id="modal-exim" tabindex="1" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <form method="post" action=" {{ route('sdm4.import') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hiddem="true"> &times; </span>
...
<!-- report -->
    <div class="modal fade" id="modal1" tabindex="1" aria-hidden="true">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <form method="post" action=" {{ route('sdm4.download') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                    {{ csrf_field() }}
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hiddem="true"> &times; </span>
            ...
            <div class="modal-body">
              <div class="box box-info">
                <div class="box-body">
                      ...
                      <a href="{{ route('sdm4.sdm4excel') }}" class="btn btn-primary" role="button">
                       <i class="fa fa-download"> Unduh Excel</i>
                      </a>
                      <a href="{{ route('sdm4.download')}}" class="btn btn-primary">
