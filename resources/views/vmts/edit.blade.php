...
<!-- Main content -->
    <section class="content">
      ...
      <!--     <form method="post" action=" {{ route('ubah.visimisi') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }} -->
              {!! Form::open(array('route' => ['standar1visimisi.update', $vmts->id_vmts],'class'=>'form-horizontal','method'=>'PUT')) !!}
                   
            <div class="box-header">
            <!-- /.box-header -->

                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="vmts" rows="50" cols="5" oneKeyPress class="form-control my-editor" name="visimisi"></textarea>
  ...
  <!--Text Editor-->
    ...
    <script>
      ...
      var contentEditor = {!! $vmts !!}.visimisi;  // the way you pars the variabel from controller
      document.getElementById('vmts').innerHTML = contentEditor; 
    </script>
