 ...
 <!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
          <form method="post" action=" {{ route('simpan.visimisi') }}" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
          {{ csrf_field() }}
            ...
            <div class="form-group">
                  ...
                  <script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
                      <textarea id="vmts" rows="40" cols="5" oneKeyPress class="form-control my-editor" name="visimisi" value="{{ old('vmts') }}"></textarea>
          </div>
           <div class="form-group" >
