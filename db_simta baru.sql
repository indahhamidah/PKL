...
--
-- Host: 127.0.0.1
-- Generation Time: 08 Apr 2018 pada 12.00
...
--
-- Struktur dari tabel `dosen_tetap`
--
...
--
-- Struktur dari tabel `hubungan_kerjasama`
--
...
--
-- Struktur dari tabel `jenis_mahasiswa`
--
...
--
-- Dumping data untuk tabel `jenis_mahasiswa`
--
...
--
-- Dumping data untuk tabel `jumlahs`
--
...
(106, 6, 9, 9, 9, 9, 9, 9, 2018, 0, 0, 0, '2018-04-05 07:34:54', '2018-04-05 07:35:04'),
(107, 6, 1, 0, 20, 0, 0, 0, 2019, 0, 0, 0, '2018-04-05 20:24:41', '2018-04-05 20:30:41'),
(108, 6, 34, 0, 500, 0, 0, 999, 2017, 0, 0, 0, NULL, NULL),
(109, 6, 8, 8, 8, 8, 8, 8, 2016, 0, 0, 0, '2018-04-06 00:23:15', '2018-04-06 00:23:15'),
(110, 6, 6, 6, 6, 6, 6, 6, 2015, 0, 0, 0, '2018-04-06 00:26:17', '2018-04-06 00:26:17'),
(111, 6, 4, 4, 4, 4, 4, 4, 2014, 0, 0, 0, '2018-04-06 00:27:41', '2018-04-06 00:27:41'),
...
(2, 2, 'bb', 'bb', '2017', '2018-04-02 00:55:25', '2018-04-02 00:55:25'),
(3, 6, 'Pesta Sains Nasional (setiap tahun sejak tahun 2004)', 'FMIPA', '2018', '2018-04-02 10:32:20', '2018-04-02 10:32:20'),
(5, 2, 'k', 'h', '2016', '2018-04-03 00:04:30', '2018-04-03 00:40:34'),
(8, 2, 'aa', 'aa', '2016', '2018-04-03 00:13:58', '2018-04-03 00:13:58'),
(11, 2, 'k', 'k', '2016', '2018-04-03 00:18:12', '2018-04-03 00:18:12'),
(13, 2, 'm', 'm', '2016', '2018-04-03 00:20:14', '2018-04-03 00:20:14'),
(15, 2, 'n', 'n', '2017', '2018-04-04 07:10:13', '2018-04-04 07:10:13'),
(16, 6, 'cpsc', 'ilkom', '2018', '2018-04-05 20:56:21', '2018-04-05 20:56:21');

-- --------------------------------------------------------

--
-- Struktur dari tabel `lulusans`
--
...
--
-- Dumping data untuk tabel `lulusans`
--
...
(48, 6, 'rr', 'G6121212', 'rr', 'rr', 'r', 'rr', '2012-03-31', '2016-08-06', '53.13', '4.53', '3.7', '2018-03-30 12:44:58', '2018-04-07 02:12:50'),
...
(50, 6, 'vv', 'G6121213', 'vv', 'vv', NULL, 'vv', '2013-03-31', '2017-09-30', '48.21', '4.48', '2.9', '2018-03-31 00:39:56', '2018-03-31 05:37:21'),
...
(69, 6, 'oo', 'G6120001', 'oo', 'jj', NULL, '00', '2011-06-16', '2015-07-15', '49.20', '4.49', '3.5', '2018-04-07 02:05:47', '2018-04-07 02:05:47'),
(70, 6, 'rt', 'rt', 'rt', 'rr', NULL, 'tr', '2012-06-13', '2015-11-25', '42.0', '3.42', '3.5', '2018-04-07 02:33:56', '2018-04-07 02:33:56'),
(71, 6, 'gygg', 'gy', 'gy', 'y', NULL, 'gy', '2013-06-11', '2017-07-18', '49.28', '4.49', '2.45', '2018-04-07 02:37:02', '2018-04-07 02:39:25'),
...
--
-- Struktur dari tabel `penerimaans`
--
...
--
-- Dumping data untuk tabel `penerimaans`
--
...
--
-- Struktur dari tabel `penerimaan_dana`
--
...
--
-- Dumping data untuk tabel `penerimaan_dana`
--
...
--
-- Struktur dari tabel `penggantian_dosen`
--
...
--
-- Struktur dari tabel `perencanaan_dosen`
--
...
--
-- Struktur dari tabel `perencanaan_tkpd`
--
...
--
-- Struktur dari tabel `prasarana_tambahan`
--
...
--
-- Struktur dari tabel `sarana_tambahan`
--
...
--
-- Struktur dari tabel `tipe_mahasiswa`
--
...
--
-- Dumping data untuk tabel `tipe_mahasiswa`
--
...
(9, 10, 1, 'Super Admin', 'Super_Admin', 'superadmin@gmail.com', '$2y$10$Jo/Owzzc1cNYwZiVJ6zglun.RncyLAb9pDRb8zURG5S3urpTCkOc6', 'X7J33B64xaxGnTZWqXzwqJC5vqFlJ7Q9V7IpxTFhA0tD5jmEgsnvU9BjMYqt', '2018-03-06 07:26:31', '2018-03-06 07:26:31'),
...
(12, 6, 3, 'Ketua Program Studi', 'Ketua_Prodi', 'kaprodi@gmail.com', '$2y$10$2MN3EmERPhLM6sA1RdnCv.2nDm8dHZzrCvXPO2WGhGnaWQRfcHTAO', '9y7ZtCYtHG9bNQjfvPLw603yNG7Qte7m5jmDQA1xZySNF9N0RDGdThtenHOi', '2018-03-09 00:40:11', '2018-03-09 00:40:11'),
...
--
ALTER TABLE `jumlahs`
  MODIFY `id_jumlah` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
--
-- AUTO_INCREMENT for table `kegiatan`
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `lulusans`
--
ALTER TABLE `lulusans`
  MODIFY `id_lulusan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
